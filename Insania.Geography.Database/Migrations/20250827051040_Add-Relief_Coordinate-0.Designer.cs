...
namespace Insania.Geography.Database.Migrations
{
    ...
    [Migration("20250827051040_Add-Relief_Coordinate-0")]
    partial class AddRelief_Coordinate0
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Insania.Geography.Entities.GeographyObjectCoordinate", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("Id"));
                    NpgsqlPropertyBuilderExtensions.HasIdentityOptions(b.Property<long>("Id"), 79L, null, null, null, null, null);
            ...
            modelBuilder.Entity("Insania.Geography.Entities.Relief", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("c_relief", "insania_geography", t =>
                        {
                            t.HasComment("Рельефы");
                        });
                });

            modelBuilder.Entity("Insania.Geography.Entities.ReliefCoordinate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ReliefId")
                        ...
                        .HasComment("Идентификатор рельефа");
                    ...
                    b.HasIndex("CoordinateId", "ReliefId", "DateDeleted")
                        .IsUnique();

                    b.ToTable("u_reliefs_coordinates", "insania_geography", t =>
                        {
                            t.HasComment("Координаты рельефов");
                        });
                });
            ...
            modelBuilder.Entity("Insania.Shared.Entities.Coordinate", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("Id"));
                    NpgsqlPropertyBuilderExtensions.HasIdentityOptions(b.Property<long>("Id"), 41L, null, null, null, null, null);
            ...
            modelBuilder.Entity("Insania.Geography.Entities.ReliefCoordinate", b =>
                {
                    ...
                    b.HasOne("Insania.Geography.Entities.Relief", "ReliefEntity")
                        .WithMany()
