...
{
    [DbContext(typeof(LogsApiGeographyContext))]
    partial class LogsApiGeographyContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("insania_logs_api_geography")
                .HasAnnotation("ProductVersion", "9.0.6")
                .HasAnnotation("Relational:MaxIdentifierLength", 63);

            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("Insania.Geography.Entities.LogApiGeography", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("r_logs_api_geography", "insania_logs_api_geography", t =>
                        {
                            t.HasComment("Логи сервиса географии");
                        });
                });
