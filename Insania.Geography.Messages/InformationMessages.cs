namespace Insania.Geography.Messages;
...
public static class InformationMessages
{
    ...
    public const string EnteredGetListGeographyObjectCoordinatesMethod = "Вошли в метод получения списка координат географического объекта";
    ...
    public const string EnteredGetListReliefsCoordinatesMethod = "Вошли в метод получения списка координат рельефов";
